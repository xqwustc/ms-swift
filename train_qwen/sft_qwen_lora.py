...
# model
model_id_or_path = QWEN3_MODEL_PATH
system = 'You are a helpful assistant.'
output_dir = 'output'

# dataset
dataset = [SELF_COGNITION_DATASET_PATH]  # dataset_id or dataset_path
data_seed = 42
max_length = 2048
split_dataset_ratio = 0.01  # Split validation set
num_proc = 4  # The number of processes for data loading.
# The following two parameters are used to override the placeholders in the self-cognition dataset.
model_name = ['小泉', 'Xiao Quan']  # The Chinese name and English name of the model
model_author = ['STEVEN', 'STEVEN']  # The Chinese name and English name of the model author
...
logger.info(f'train_dataset: {train_dataset} with length {len(train_dataset)}')
logger.info(f'val_dataset: {val_dataset} with length {len(val_dataset)}')
